...
// type generated from https://github.com/RegenNetwork/regen-registry-standards/blob/main/jsonld/C03/credit-batch-metadata/C03-batch-minimal-example.jsonld
